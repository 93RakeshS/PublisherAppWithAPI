    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, 0m, new DateTime(2023, 2, 27, 11, 38, 41, 549, DateTimeKind.Local).AddTicks(6314), "NewBook" },
                    { 2, 2, 0m, new DateTime(2023, 2, 27, 11, 38, 41, 549, DateTimeKind.Local).AddTicks(6323), "NewTextBook" },
                    { 3, 3, 0m, new DateTime(2023, 2, 27, 11, 38, 41, 549, DateTimeKind.Local).AddTicks(6324), "NewPictureBook" },
                    { 4, 3, 0m, new DateTime(2023, 2, 27, 11, 38, 41, 549, DateTimeKind.Local).AddTicks(6324), "NewComicBook" },
                    { 5, 4, 0m, new DateTime(2023, 2, 27, 11, 38, 41, 549, DateTimeKind.Local).AddTicks(6325), "Genshin Lore" }
                });
